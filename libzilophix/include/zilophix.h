...
#define LIBZILOPHIX_VERSION_MINOR       0                           /* Library minor version  */

#define FORMAT_VERSION_1_0              0x10                        /* Version code of ZilophiX 1.0 */
#define FORMAT_VERSION_1_1              0x11                        /* Version code of ZilophiX 1.1 */
#define FORMAT_VERSION_CURRENT          FORMAT_VERSION_1_1          /* The version code of the encoder output data. */
#define CURRENT_FORMAT_VERSION_NAME     "1.1"                       /* Current format version name. */
